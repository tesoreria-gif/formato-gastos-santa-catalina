  ...
  "gastos": [
    {
      "fecha": string o null,
      "concepto": string,
      "categoria": "Combustible" | "Hospedaje" | "Alimentación" | "Descargue" | "Otros (Peajes, Transporte, Parqueaderos)",
      "valor": number,
      "numero_recibo": string o null,
      "observaciones": string o null,
      "galones": number o null,
      "precio_galon": number o null
    }
  ],
...
- "categoria" debe ser exactamente una de las cinco opciones listadas, elige la más adecuada.
- "galones" y "precio_galon" solo aplican cuando "categoria" es "Combustible" y el documento muestra esos datos (tanqueada); en cualquier otro caso usa null. Si el documento trae varias tanqueadas de combustible, genera un gasto separado por cada una.
